        ...
        $(document).ready(function() {
            ...
            const fieldTypes = {
                ...
                headboard_radio: {
                    ...
                    <div class="mb-3 custom-radio-field-container">
                        ...
                        <button type="button" class="btn btn-secondary btn-sm mt-2 add-custom-radio-option">
                ...
                radio: {
                    ...
                    <div class="mb-3">
                        ...
                        <div class="radio-options-container">
                            <div class="radio-option mb-2">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input field-input" name="option_active[]">
                        ...
                        <button type="button" class="btn btn-secondary btn-sm mt-2 add-radio-option">
                            <i class="fa fa-plus"></i> Add Option
                        </button>
                    </div>
                `
                ...
                colors: {
                        ...
                        <div class="color-options-container">
                            <div class="color-option mb-2" id="color_option_0">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm remove-color"><i class="fa fa-times"></i></button>
                                </div>
                            </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label">Allow Multiple Selection</label>
                        <div class="form-check">
            ...
            function updateStepJSON() {
                ...
                $(".add_Step .card").each(function(index) {
                    ...
                    let templateValue = $(this).find('.template-select').val();
                    ...
                    const labelField = $(this).find('input[placeholder="Enter form name"]');
                    const mainHeadingField = $(this).find('input[placeholder="Enter main heading"]');
                    const subheadingField = $(this).find('input[placeholder="Enter subheading"]');
                    const sideHeadingField = $(this).find('input[placeholder="Enter side heading"]');
                    ...
                    $(this).find(".field-container .accordion").each(function() {
                        ...
                        $(this).find('.field-options .field-input').each(function() {
                            ...
                            // Handle custom radio options
                                ...
                                let thisFieldId = $(this).closest('.accordion').attr("id")
                                    .replace("accordion-", "");
                        ...
                        if (!fieldData.label) {
                            ...
                            if (labelField.length) {
                                fieldData.label = labelField.val() || 'New Field';
                            }
                        }
            ...
            $(document).on("click", ".addField", function() {
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="heading-${fieldId}">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                <i class="fa fa-arrows-alt move-icon-field me-3" style="cursor: grab;"></i>
                            </button>
                ...
                stepCard.find(`#accordion-${fieldId} .field-type-select`).on('change', function() {
                    const type = $(this).val();
                    const $opts = $(this).closest('.accordion-body').find('.field-options');
            ...
            $(document).on("change", ".field-type-select", function() {
                ...
                const fieldId = $(this).closest('.accordion').attr('id').replace('accordion-', '');
                ...
                const currentLabel = $(this).closest('.accordion').find('.field-label').text();
                if (currentLabel && currentLabel !== 'New Field') {
                    ...
                    $fieldOptions.find('.add-slide-option').on('click', function() {
                        ...
                        <div class="slide-option mb-2 p-2 border rounded">
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                ...
                                <button type="button" class="btn btn-danger btn-sm remove-slide-option mt-3"><i class="fa fa-times"></i></button>
                            </div>
                        </div>`;
                        ...
                        <div class="card-body collapse show" id="${contentId}">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-2">
                                        <label class="fw-bold">Label:</label>
                                        <input type="text" class="form-control step-input step-label-input" placeholder="Enter form name" value="${step.label || ''}" />
                                    </div>
                                    <div class="mb-2">
                                        <label class="fw-bold">Main Heading:</label>
                                        <input type="text" class="form-control step-input" placeholder="Enter main heading" value="${step.mainHeading || ''}" />
                                    </div>
                                    <div class="mb-2">
                                        <label class="fw-bold">Subheading:</label>
                                        <input type="text" class="form-control step-input" placeholder="Enter subheading" value="${step.subheading || ''}" />
                                    </div>
                                    <div class="mb-2">
                                        <label class="fw-bold">Side Heading:</label>
                                        <input type="text" class="form-control step-input" placeholder="Enter side heading" value="${step.sideHeading || ''}" />
                                    </div>
                                    <div class="mb-2">
                                        <label class="fw-bold">Template:</label>
                                        <select class="form-select template-select">
                    ...
                    if (step.fields && step.fields.length > 0) {
                        ...
                        <div class="accordion mt-2" id="accordion-${fieldId}">
                            ...
                            const $fieldOptions = stepCard.find(
                                `#accordion-${fieldId} .field-options`);
                                        ...
                                        field.options.forEach(function(option, index) {
                                            ...
                                            <div class="custom-radio-option mb-2 p-2 border rounded" id="${optionId}" data-field-id="${fieldId}">
                                                  <div class="m-2">
                                                     ...
                                                     <div class="d-flex p-2 flex-column">
                                                        ...
                                                        <div class="d-flex gap-2">
                                                            <div class="d-flex flex-column">
                                                                ...
                                                                <input type="text" class="form-control field-input" name="option_mid_sized[]" placeholder="price" value="${option.mid_sized_price || ''}">
                                                            </div>
                                                            <div class="d-flex flex-column">
                                                                <label class="form-label">Toyota 79</label>
                                                                <input type="text" class="form-control field-input" name="option_toyota_79[]" placeholder="price" value="${option.toyota_79_price || ''}">
                                                            </div>
                                                            <div class="d-flex flex-column">
                                                                <label class="form-label">USA Truck</label>
                                                                <input type="text" class="form-control field-input" name="option_usa_truck[]" placeholder="price" value="${option.usa_truck_price || ''}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm custom-radio-remove-btn" data-option-id="${optionId}"><i class="fa fa-times"></i></button>
                                                </div>
                                            </div>`;
                    ...
                    <div class="m-2">
                        ...
                        <div class="d-flex p-2 flex-column">
                            ...
                            <div class="d-flex gap-2">
                                <div class="d-flex flex-column">
                                    <label class="form-label">Mid Sized</label>
                                    <input type="text" class="form-control field-input" name="option_mid_sized[]" placeholder="price">
                                </div>
                                <div class="d-flex flex-column">
                                    <label class="form-label">Toyota 79</label>
                                    <input type="text" class="form-control field-input" name="option_toyota_79[]" placeholder="price">
                                </div>
                                <div class="d-flex flex-column">
                                    <label class="form-label">USA Truck</label>
                                    <input type="text" class="form-control field-input" name="option_usa_truck[]" placeholder="price">
                                </div>
                            </div>
                        </div>
                        <div class="form-check w-100 m-2 ">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <input type="text" class="black-image-datawith-headboard" name="black_image_url_withHeadboard[]">
